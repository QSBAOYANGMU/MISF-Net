...
class MISFNet(nn.Module):
    def __init__(self, pretrained=True):
        ...
        self.shared_1.add_module('shared_activation_1', nn.ReLU(inplace=True))
        self.shared_2 = nn.Sequential()
        self.shared_2.add_module('shared_1', nn.Conv2d(128, 128,kernel_size=3,padding=1))
        # self.shared_2.add_module('shared_bn_1', nn.BatchNorm2d(128))
        self.shared_2.add_module('shared_activation_1', nn.ReLU(inplace=True))
        self.shared_4 = nn.Sequential()
        self.shared_4.add_module('shared_1', nn.Conv2d(256, 256,kernel_size=3,padding=1))
        # self.shared_4.add_module('shared_bn_1', nn.BatchNorm2d(256))
        self.shared_4.add_module('shared_activation_1', nn.ReLU(inplace=True))
        self.shared_8 = nn.Sequential()
        self.shared_8.add_module('shared_1', nn.Conv2d(512, 512, kernel_size=3, padding=1))
        # self.shared_8.add_module('shared_bn_1', nn.BatchNorm2d(512))
        self.shared_8.add_module('shared_activation_1', nn.ReLU(inplace=True))
        self.shared_16 = nn.Sequential()
        self.shared_16.add_module('shared_1', nn.Conv2d(512, 512, kernel_size=3, padding=1))
        # self.shared_16.add_module('shared_bn_1', nn.BatchNorm2d(512))
        self.shared_16.add_module('shared_activation_1', nn.ReLU(inplace=True))

        ##########################################
        #private encoder
        ##########################################
        self.private_16 = nn.Sequential()
        self.private_16.add_module('shared_1', nn.Conv2d(512, 512, kernel_size=3, padding=1))
        # self.shared_16.add_module('shared_bn_1', nn.BatchNorm2d(512))
        self.private_16.add_module('shared_activation_1', nn.ReLU(inplace=True))

        self.private_16_t = nn.Sequential()
        self.private_16_t.add_module('shared_1', nn.Conv2d(512, 512, kernel_size=3, padding=1))
        # self.shared_16.add_module('shared_bn_1', nn.BatchNorm2d(512))
        self.private_16_t.add_module('shared_activation_1', nn.ReLU(inplace=True))

        self.private_8 = nn.Sequential()
        self.private_8.add_module('shared_1', nn.Conv2d(512, 512, kernel_size=3, padding=1))
        # self.shared_16.add_module('shared_bn_1', nn.BatchNorm2d(512))
        self.private_8.add_module('shared_activation_1', nn.ReLU(inplace=True))

        self.private_8_t = nn.Sequential()
        self.private_8_t.add_module('shared_1', nn.Conv2d(512, 512, kernel_size=3, padding=1))
        # self.shared_16.add_module('shared_bn_1', nn.BatchNorm2d(512))
        self.private_8_t.add_module('shared_activation_1', nn.ReLU(inplace=True))

        self.private_4 = nn.Sequential()
        self.private_4.add_module('shared_1', nn.Conv2d(256, 256, kernel_size=3, padding=1))
        # self.shared_16.add_module('shared_bn_1', nn.BatchNorm2d(512))
        self.private_4.add_module('shared_activation_1', nn.ReLU(inplace=True))

        self.private_4_t = nn.Sequential()
        self.private_4_t.add_module('shared_1', nn.Conv2d(256, 256, kernel_size=3, padding=1))
        # self.shared_16.add_module('shared_bn_1', nn.BatchNorm2d(512))
        self.private_4_t.add_module('shared_activation_1', nn.ReLU(inplace=True))

        self.private_2= nn.Sequential()
        self.private_2.add_module('shared_1', nn.Conv2d(128, 128, kernel_size=3, padding=1))
        # self.shared_16.add_module('shared_bn_1', nn.BatchNorm2d(512))
        self.private_2.add_module('shared_activation_1', nn.ReLU(inplace=True))

        self.private_2_t = nn.Sequential()
        self.private_2_t.add_module('shared_1', nn.Conv2d(128, 128, kernel_size=3, padding=1))
        # self.shared_16.add_module('shared_bn_1', nn.BatchNorm2d(512))
        self.private_2_t.add_module('shared_activation_1', nn.ReLU(inplace=True))

        self.private_1 = nn.Sequential()
        self.private_1.add_module('shared_1', nn.Conv2d(64, 64, kernel_size=3, padding=1))
        # self.shared_16.add_module('shared_bn_1', nn.BatchNorm2d(512))
        self.private_1.add_module('shared_activation_1', nn.ReLU(inplace=True))

        self.private_1_t = nn.Sequential()
        self.private_1_t.add_module('shared_1', nn.Conv2d(64, 64, kernel_size=3, padding=1))
        # self.shared_16.add_module('shared_bn_1', nn.BatchNorm2d(512))
        self.private_1_t.add_module('shared_activation_1', nn.ReLU(inplace=True))
